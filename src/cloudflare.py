...
class CF:
    ...
    def __init__(self, token : str = None, zone_name : str = None, dns_name_proxied : str = None, dns_name_not_proxied : str = None):
    ...
    def _delete_records_(self, dns_name: str):
        dns_records = self._cf.zones.dns_records.get(self._zone_id, params={'name':dns_name + '.' + self._zone_name})
